...
describe("MirrorTrading", function () {
  ...
  beforeEach(async () => {
    ...
    router = await contractAt(
      "Router",
      "0xaBBc5F99639c9B6bCb58544ddf04EFA6802F4064"
    );
    weth = await contractAt(
      "Token",
    ...
    decreaseMasterToFollow = "0xa2683c71becb07e21155313f46f6ba00986414c3";
    // collateralToken = await contractAt("Token", "0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8")//USDC
    // collateralTokenDecimals = 6 //USDC
    collateralToken = await contractAt(
      "Token",
      "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1"
    );
    indexToken = await contractAt(
      "Token",
      "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1"
    );
